...
func TestNewBroadcaster(t *testing.T) {
	...
	fromAddress := "cosmos1testaddress"
...
func TestRegistry_GetOrCreateBroadcaster(t *testing.T) {
	...
	differentAddress := "cosmos1differentaddress"
...
func TestRegistry_Close(t *testing.T) {
	...
	b1 := r.GetOrCreateBroadcaster(ctx, broadcastFunc, key1, "cosmos1addr1")
	b2 := r.GetOrCreateBroadcaster(ctx, broadcastFunc, key2, "cosmos1addr2")
	b3 := r.GetOrCreateBroadcaster(ctx, broadcastFunc, key3, "cosmos1addr3")
